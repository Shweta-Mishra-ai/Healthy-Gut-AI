...
pull requests over large speculative ones — this approach enables fast reviews
and ensures the `main` branch remains deployable at all times.
...
2. **No provider outage should ever 500 the app.** If you touch
   ...
   OpenAI, and Mock) still degrades gracefully on your change.
...
All 41 existing tests must pass before you open a PR. Add new tests under
